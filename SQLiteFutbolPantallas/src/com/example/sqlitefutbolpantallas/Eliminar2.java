...
public class Eliminar2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.eliminar2);
	...
	public void eliminar(View view) {
		...
		String sql = "DELETE FROM Futbol WHERE dni='" + dni.getText().toString() + "'";
		db.execSQL(sql);
		Toast.makeText(Eliminar2.this, "Jugador eliminado correctamente.", Toast.LENGTH_LONG).show();
	}
